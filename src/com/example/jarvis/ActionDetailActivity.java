...
public class ActionDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ActionDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ActionDetailFragment.ARG_ITEM_ID));
            ActionDetailFragment fragment = new ActionDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.action_detail_container, fragment)
                    .commit();
        }
    }
